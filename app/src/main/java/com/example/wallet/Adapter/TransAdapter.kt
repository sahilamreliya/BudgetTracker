...
class TransAdapter(detele: (Int) -> Unit, update: (homemodal) -> Unit) :
    RecyclerView.Adapter<TransAdapter.TransHolder>() {

    var deletClick = detele
    var updateClick = update
    lateinit var transaction: ArrayList<homemodal>
    ...
    fun addTrans(transaction: ArrayList<homemodal>) {
        this.transaction = transaction
    }

    fun update(transaction: ArrayList<homemodal>) {
